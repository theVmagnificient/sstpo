...
<script src="/js/add_skyscrappers.js"></script>
...
<script>
    ...
    function submitadd() {
        black.style.display = 'none';
        chooseconwrapper.style.display = 'none';
        if (document.getElementsByClassName('choose-checkbox')[0].checked) {
            var xmxHttp = new XMLHttpRequest();
            xmxHttp.open("GET", '/api/setfav.php?mode=0&entid=' + document.getElementsByClassName('result-title')[mkind].id + '&listid=0', true);
            xmxHttp.send(null);
        }
        if (document.getElementsByClassName('choose-checkbox')[1].checked) {
            var xmxxHttp = new XMLHttpRequest();
            xmxxHttp.open("GET", '/api/setfav.php?mode=0&entid=' + document.getElementsByClassName('result-title')[mkind].id + '&listid=1', true);
            xmxxHttp.send(null);
        }
        if (document.getElementsByClassName('choose-checkbox')[2].checked) {
            var xmxxxHttp = new XMLHttpRequest();
            xmxxxHttp.open("GET", '/api/setfav.php?mode=0&entid=' + document.getElementsByClassName('result-title')[mkind].id + '&listid=2', true);
            xmxxxHttp.send(null);
        }
        if (document.getElementsByClassName('choose-checkbox')[3].checked) {
            var xmxxxxHttp = new XMLHttpRequest();
            xmxxxxHttp.open("GET", '/api/setfav.php?mode=0&entid=' + document.getElementsByClassName('result-title')[mkind].id + '&listid=3', true);
