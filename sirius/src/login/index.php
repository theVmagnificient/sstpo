        ...
        <div class="login-wrapper">
            <div class="login-block">
                ...
                <div class="input-container">
                    <input class="login-input-firstname" type="text" placeholder="Имя">
                    <input class="login-input-surname" type="text" placeholder="Фамилия">
                    <input class="login-input-email" type="email" placeholder="E-mail">
                    <input class="login-input-password" type="password" placeholder="Пароль">
                </div>
                <div class="result-log-container"></div>
                <div class="login-button signin-button" onclick=signinbut()>
                    Войти
                </div>
                <div class="login-button signup-button" onclick=signupbut()>
                    Регистрация
                </div>
            </div>
        </div>
