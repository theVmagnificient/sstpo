    ...
    <main>
        ...
        <div class="ent-con">
            ...
            if (strlen($line['fav_cli']) > 2) {
                echo '<h3>Клиенты:</h3><br><div class="slider-wrapper"><div class="slider"><div class="slider-nav-but" id="snbbb-left" style="display: block;">&lt;</div> <div class="slider-nav-but" id="snbbb-right" style="display: block;">&gt;</div><div class="sicw"">';
